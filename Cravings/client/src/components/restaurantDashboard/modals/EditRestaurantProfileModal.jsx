    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
      <div className="bg-[#1E293B] text-white w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* Personal Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4 pb-2 border-b border-[#334155]">Personal Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full border rounded-md p-2 bg-[#0F172A] text-white focus:outline-none focus:ring-2 focus:ring-[#2563EB] ${
                    errors.fullName ? "border-red-500" : "border-[#334155]"
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  className="w-full border rounded-md p-2 bg-[#334155] text-gray-300 cursor-not-allowed"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full border rounded-md p-2 bg-[#0F172A] text-white focus:outline-none focus:ring-2 focus:ring-[#2563EB] ${
                    errors.mobileNumber ? "border-red-500" : "border-[#334155]"
                  }`}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full border rounded-md p-2 bg-[#0F172A] text-white focus:outline-none focus:ring-2 focus:ring-[#2563EB] border-[#334155]"
                >
          ...
          {/* Restaurant Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4 pb-2 border-b border-[#334155]">Restaurant Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full border rounded-md p-2 bg-[#0F172A] text-white focus:outline-none focus:ring-2 focus:ring-[#2563EB] ${
                    errors.restaurantName ? "border-red-500" : "border-[#334155]"
                  }`}
          ...
          {/* Address Section */}
          <div>
            <h3 className="text-lg font-semibold mb-4 pb-2 border-b border-[#334155]">Address</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full border rounded-md p-2 bg-[#0F172A] text-white focus:outline-none focus:ring-2 focus:ring-[#2563EB] ${
                    errors.city ? "border-red-500" : "border-[#334155]"
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full border rounded-md p-2 bg-[#0F172A] text-white focus:outline-none focus:ring-2 focus:ring-[#2563EB] ${
                    errors.pin ? "border-red-500" : "border-[#334155]"
                  }`}
          ...
          <div className="flex justify-end gap-4 pt-6 border-t border-[#334155]">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 bg-[#2563EB] text-white rounded-md hover:bg-[#1D4ED8] transition disabled:opacity-50 flex items-center gap-2"
            >
