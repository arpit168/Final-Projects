    ...
    <div className="bg-[#F1F5F9] text-[#1E293B] overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto md:flex items-center rounded-2xl relative z-10 shadow-2xl shadow-orange-900  ">
            <div data-aos="flip-left" className="space-y-6 p-5 rounded-s-2xl">
             ...
             <div className="flex justify-center">
              ...
              <div className="grid grid-cols-3 shadow-2xl rounded-2xl text-nowrap md:shadow-none shadow-gray-500   text-center gap-8 p-2 pt-12">
      ...
      <section className="py-28 bg-[#1E293B] text-white text-center">
        ...
        <p className="text-slate-300 mb-10 text-lg">
          Join thousands of satisfied customers and enjoy premium food delivered
          to your doorstep.
        </p>
