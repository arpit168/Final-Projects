...
//   return (
//     <>
//       <div className="bg-gray-700 md:pb-0 pb-10">
...
//                   src={kit}
//                   alt=""
//                   className="rounded-2xl hidden md:flex h-75 animate-pulse hover:animate-none"
//                   data-aos="fade-left"
//                 />
//                 <img
//                   src={arp}
//                   alt=""
//                   className="rounded-2xl hidden md:flex object-cover w-125 h-100 animate-pulse hover:animate-none"
//                 />
//               </div>
//             </div>
...
//                     className="w-full mx-2 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
//                   />
//                 </div>
//                 <div>
